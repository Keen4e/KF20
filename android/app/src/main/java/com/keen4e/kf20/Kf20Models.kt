...
internal data class AiExecution(val provider: String, val credentialMode: String, val storage: String)
internal data class AiBridgeStatus(val provider: String, val storage: String, val ready: Boolean)
internal data class NutritionAnalysis(val estimate: NutritionEstimate, val execution: AiExecution)
